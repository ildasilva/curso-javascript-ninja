...
(function(){
  ...
  */
  ...
  console.log(texto.replace(/(Manuel Marques de Sousa)/g, 'Ilda Emanoely Ribeiro'));
  ...
  */
  ...
  console.log(texto.replace(/(brasileiro)/g, 'goiana'));
  /*
  ...
  */
  ...
  texto.replace(/(O centauro de Luvas)/g, function(capturatotal, letra1){
